...
REM Update Banner Title and subtitle font and color before we create transform file
@C:\Windows\System32\cscript.exe "%MSIProjectPath%\CustomWix.js" "%MSIEnglishPath%\%MSIFileName%_%MSICultureCode%.msi" %MSICultureCode%
